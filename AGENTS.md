...
- Antes de trabajar, leer `CONTEXTOS.md` y `ACTUALIZACIONES.md` completos.
- `CONTEXTOS.md` mantiene la fotografía integral del proyecto.
- `ACTUALIZACIONES.md` mantiene la bitácora cronológica.
- Al terminar un cambio importante, actualizar el estado publicado, pendiente y próximo paso.
- No guardar contraseñas, tokens ni contenido de `.env` en la bitácora.
